...
parser.add_argument('--freeze_layers', default=3, type=int, choices=[0,1,2,3,4], help='freezing first few conv layers from alexnet. Choices: 0,1,2,3,4')
...
net = alexnet
net.load_state_dict(torch.load(args.alexnet_path))
...
net_featWtNm = net_featWtNm[args.freeze_layers:]
net_featBiasNm = net_featBiasNm[args.freeze_layers:]
...
sgd_params = [
    {'params': netfeatwt, 'lr': opt['lr'], 'momentum': opt['momentum'], 'weight_decay': opt['net_wtDcy'], 'lr_mul': opt['net_wtLR'], 'name': 'netfeatwt'},
    {'params': netfeatbias, 'lr': opt['lr'], 'momentum': opt['momentum'], 'weight_decay': opt['net_biasDcy'], 'lr_mul': opt['net_biasLR'], 'name': 'netfeatbias'},
    {'params': net2_weight, 'lr': opt['lr'], 'momentum': opt['momentum'], 'weight_decay': opt['btl_wtDcy'], 'lr_mul': opt['btl_wtLR'], 'name': 'net2wt'},
    {'params': net2_bias, 'lr': opt['lr'], 'momentum': opt['momentum'], 'weight_decay': opt['btl_biasDcy'], 'lr_mul': opt['btl_biasLR'], 'name': 'net2bias'}
]
