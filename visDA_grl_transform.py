...
train_dir = domainData['vistrain']
val_dir = domainData['visval']
num_classes = NUM_CLASSES['visDA'] # 'office', 'visDA'
EPOCHS = 5
...
torch.save(model_ft.state_dict(), "visDA_train_grl_with_transform.pth")
...
save_name = "visDA_final_grl_with_transform.pth"
